...
interface MapperBinder
{
	void startMapperMode(String mapID);
	boolean stopMapperMode(String mapID);
	boolean uploadMap(String mapID, OnChangeString uploadSuccessEvent, OnChange uploadFail);
