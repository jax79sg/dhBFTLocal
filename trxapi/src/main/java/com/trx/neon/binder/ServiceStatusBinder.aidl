...
oneway interface ServiceStatusBinder
{
	oneway void registerConnectivityEventUpdates(OnChangeConnectivityEvent onChange);
	oneway void unregisterConnectivityEventUpdates(OnChangeConnectivityEvent onChange);
}